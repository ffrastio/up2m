...
<div class="form-group">
    ...
    @if ($errors->any())
        {!! Form::password('password', $errors->has('password') ? [null, 'placeholder' => 'Password', 'class' => 'form-control is-invalid'] : [null, 'placeholder' => 'Password', 'class' => 'form-control is-valid']) !!}
    @else
...
<div class="form-group">
    ...
    @if (isset($user))
        @if (isset($user->profile_photo_path))
            <img src="{{ Storage::url($user->profile_photo_path) }}" width="30%">
        @else
