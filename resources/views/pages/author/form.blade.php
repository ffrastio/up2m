...
<div class="form-group">
    ...
    @if ($errors->any())
        {!! Form::text('jurusan', old('jurusan'), $errors->has('jurusan') ? ['placeholder' => 'Jurusan', 'class' => 'form-control is-invalid'] : ['placeholder' => 'Jurusan', 'class' => 'form-control is-valid']) !!}
    @else
        {!! Form::text('jurusan', old('jurusan'), ['placeholder' => 'Jurusan', 'class' => 'form-control', 'disabled' => 'disabled']) !!}
    @endif
...
<div class="form-group">
    ...
    @if (count($list_prodi) > 0)
        {!! Form::select('id_prodi', $list_prodi, null, ['class' => 'form-control', 'id' => 'id_prodi', 'placeholder' => 'Pilih Prodi']) !!}
    @else
